    ...
    '/v1/organizations/:organizationId': {
      ...
      patch: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/OrganizationPatchRequest' },
            },
          },
        },
        responses: {
    ...
    '/v1/organizations/:organizationId/services': {
      ...
      post: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/ServicePostRequest' },
            },
          },
        },
        responses: {
    ...
    '/v1/organizations/:organizationId/services/:serviceId': {
      ...
      patch: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/ServicePatchRequest' },
            },
          },
        },
        responses: {
    ...
    '/v1/organizations/:organizationId/services/:serviceId/state': {
      patch: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/ServiceStatePatchRequest' },
            },
          },
        },
        responses: {
    ...
    '/v1/organizations/:organizationId/keys': {
      ...
      post: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/ApiKeyPostRequest' },
            },
          },
        },
        responses: {
    ...
    '/v1/organizations/:organizationId/invitations': {
      ...
      post: {
        ...
        requestBody: {
          content: {
            'application/json': {
              schema: { $ref: '#/components/schemas/InvitationPostRequest' },
            },
          },
        },
        responses: {
    ...
    schemas: {
      ServiceEndpoint: {
        properties: {
          ...
          host: { type: 'string', description: 'Service host name' },
          port: { type: 'number', description: 'Numeric port' },
        },
      },
      IpAccessListEntry: {
        properties: {
          source: { type: 'string', description: 'IP or CIDR' },
          description: {
            type: 'string',
      ...
      Service: {
        properties: {
          ...
          ipAccessList: {
            ...
            items: { $ref: '#/components/schemas/IpAccessListEntry' },
          },
          createdAt: {
            type: 'string',
      ...
      Backup: {
        properties: {
          ...
          serviceId: { type: 'string', description: 'Name ' },
          startedAt: {
            type: 'string',
      ...
      ApiKey: {
        properties: {
          ...
          roles: {
            ...
            items: { type: 'string', enum: ['admin', 'developer'] },
          },
          keySuffix: {
            type: 'string',
      ...
      ServicePatchRequest: {
        properties: {
          name: { type: 'string', description: 'Name of the service.' },
          ipAccessList: { $ref: '#/components/schemas/IpAccessListPatch' },
        },
      },
      ...
      ApiKeyPostRequest: {
        properties: {
          ...
          hashData: { $ref: '#/components/schemas/ApiKeyHashData' },
          roles: {
            type: 'array',
            description:
              'List of roles assigned to the key. Contains at least 1 element.',
